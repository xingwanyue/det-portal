...
<template>
  <div class="embark_out_wrapper">
    <div class="embark_out">
      <div class="font1">{{ $t('highscorewritingnew.font1') }}</div>
      <div class="font2">{{ $t('highscorewritingnew.font2') }}</div>
      <div v-if="!user.id" class="two_btn_out">
        <div>
          <NuxtLink
            ...
            rel="nofollow"
          >
            {{ $t('highscorewritingnew.Start_Now') }}</NuxtLink
          >
        </div>
      </div>
      <div v-else class="two_btn_out">
        <div>
          <NuxtLink class="common_btn common_btn_hover_bgColor yellow" :to="localePath(`${urlGet('/correct')}`)">
            {{ $t('highscorewritingnew.Start_Now') }}
          </NuxtLink>
        </div>
      </div>
    </div>
