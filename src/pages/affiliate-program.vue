...
useHead({
  meta: [
    { name: 'DC.title', content: t('affiliate.seometa.title') },
    { property: 'og:type', content: 'website' },
    { property: 'og:title', content: t('affiliate.seometa.title') },
    { property: 'og:description', content: t('affiliate.seometa.description') },
    { property: 'og:url', content: `https://www.${domain}${localePath('/affiliate-program')}` },
    ...
    { name: 'twitter:title', content: t('affiliate.seometa.title') },
    {
      name: 'twitter:description',
      content: t('affiliate.seometa.description'),
    },
        ...
        <div class="aff_faq">
          ...
          <div class="aff_faq_article_out">
            <div v-for="item in faqList" :key="item.id" class="one_faq">
              ...
              <div class="one_faq_answer" v-html="item.a"></div>
            </div>
          </div>
        </div>
      </div>
  ...
  .content {
    ...
    .white_dom_out {
      ...
      .white_dom {
        ...
        .img_left_dom {
          display: grid;
          grid-template-areas: 'imgarea  fontarea';
          grid-gap: 80px;
        ...
        .img_right_dom {
          margin-top: 120px;
          grid-template-areas: ' fontarea imgarea';
          @media (max-width: 1024px) {
            grid-template-areas:
              'imgarea'
              'fontarea';
